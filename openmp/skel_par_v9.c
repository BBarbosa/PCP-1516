...
void imprimeMatriz() {
    ...
    fp = fopen("output_par_v9.ascii.pbm","w");
    fprintf(fp,"%s\n",tipo);
    fprintf(fp,"%d %d\n",colunas,linhas);
...
int main(int argc, char **argv) {
    int alterou=1,i,j,vizinhos,transicoes,complementos,alterou2=1;
    int p2,p3,p4,p5,p6,p7,p8,p9,chunk;
    ...
    #pragma omp parallel num_threads(2) private(i,j,p2,p3,p4,p5,p6,p7,p8,p9,vizinhos,transicoes)
        {
            #pragma omp task
            {
                while(alterou) 
